...
**Query / body** 
- `search=` — filtering by page title
...
If `search` parameters has title fragment, use full-text-ish case-insensitive search:
```sql
SELECT *
FROM books
...
LIMIT $1 OFFSET $2;
```
where $1 = per_page, $2 = offset from formula, $3 = fragment.
...
```csv
title,book_id,published_at
Twenty Thousand Leagues,00000000-0000-0000-0000-000000000000,1905-01-01
Around the World in 80 Days,00000000-0000-0000-0000-000000000001,1905-01-01
Journey to the Centre of the Earth,00000000-0000-0000-0000-000000000002,1905-01-01
From the Earth to the Moon,00000000-0000-0000-0000-000000000003,1905-01-01
Michael Strogoff,00000000-0000-0000-0000-000000000004,1905-01-01
Five Weeks in a Balloon,00000000-0000-0000-0000-000000000005,1905-01-01
In Search of the Castaways,00000000-0000-0000-0000-000000000006,1905-01-01
Robur the Conqueror,00000000-0000-0000-0000-000000000007,1905-01-01
The Steam House,00000000-0000-0000-0000-000000000008,1905-01-01
Paris in the Twentieth Century,00000000-0000-0000-0000-000000000009,1905-01-01
around the moon,00000000-0000-0000-0000-000000000010,1905-01-01
The Green Ray,00000000-0000-0000-0000-000000000011,1905-01-01
The Mysterious Island,00000000-0000-0000-0000-000000000012,1905-01-01
Around the Moon,00000000-0000-0000-0000-000000000013,1905-01-01
```
